...
/* 
<Collapsible.Root className="sm:h-screen sm:right-auto sm:w-80 fixed  left-0 top-0  data-[state=open]:bottom-0  right-0 z-20 flex flex-col gap-6 border-b sm:border-r p-4 border-zinc-700 sm:px-5 sm:py-8 bg-app ">
<div className="flex items-center justify-between">
  <Logo />
